        ...
        <div className="flex flex-col space-y-2 mb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            {allBoards.length === 0 && !searchQuery && (
              <div className="col-span-full flex flex-col justify-center items-center py-12 px-4 border-2 border-dashed border-ikz-border rounded-2xl bg-gray-50/30">
...
function PublicBoardCard({ board, orgUuid }: { board: any; orgUuid: string }) {
  ...
  return (
    ...
    >
      <div className="block relative aspect-video overflow-hidden bg-ikz-bg">
        <div
      ...
      <div className="p-3 flex flex-col space-y-1.5">
        <h3 className="text-base font-bold text-gray-100 leading-tight group-hover:text-black transition-colors line-clamp-1">
          {board.name}
        </h3>
        ...
        <div className="pt-1.5 flex items-center justify-between border-t border-ikz-border">
          ...
          <span className="text-[10px] font-bold text-gray-400 group-hover:text-gray-100 transition-colors uppercase tracking-wider">
            Open
          </span>
        </div>
      </div>
