            ...
            <div className="flex items-center gap-3 mb-4 flex-wrap">
              <div className="relative w-full sm:w-80">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 bg-ikz-surface shadow-lg shadow-black/30 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 border-0"
                />
                {searchQuery && (
                  <button
                ...
                <div className="relative flex items-center gap-1.5">
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="pl-8 pr-8 py-2.5 bg-ikz-surface shadow-lg shadow-black/30 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 border-0 appearance-none cursor-pointer min-w-[160px]"
                    >
                  ...
                  <button
                    ...
                    className="p-1.5 text-gray-400 hover:text-gray-400 transition-colors rounded-md hover:bg-ikz-surface"
                  >
                    <Info className="w-3.5 h-3.5" />
                  </button>
                  {showUsergroupInfo && (
                    <div className="absolute top-full left-0 mt-2 z-50 w-72 bg-ikz-surface shadow-lg shadow-black/30 rounded-lg p-3 border border-ikz-border">
                      <p className="text-xs font-semibold text-gray-300 mb-1">{t('courses.usergroup_filter.info_title')}</p>
          ...
          {totalPages > 1 && (
            <div className="mt-8 flex items-center justify-center gap-2">
              <button
                ...
                className="flex items-center gap-1 px-3 py-2 text-sm font-medium text-gray-400 bg-ikz-surface shadow-lg shadow-black/30 rounded-lg hover:bg-ikz-bg disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                    ...
                    {page === '...' ? (
                      ...
                      <button
                        ...
                        className={`px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                          currentPage === page
                            ? 'bg-black text-white'
                            : 'bg-ikz-surface text-gray-400 shadow-lg shadow-black/30 hover:bg-ikz-bg'
                        }`}
                      >
                        {page}
                      </button>
