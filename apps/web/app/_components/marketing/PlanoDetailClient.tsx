          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-16">
            <div className="flex-1">
              ...
              {isPremiumPlus ? (
                ...
                <Link href="/auth/signup" className="inline-flex items-center gap-2 rounded-xl bg-ikz-lime shadow-glow-lime hover:shadow-glow-lime-lg px-8 py-4 text-sm font-bold text-ikz-bg hover:opacity-90 transition-all">
      ...
      <section className="px-6 py-20 text-center border-t border-ikz-border">
        <div className="mx-auto max-w-xl">
          ...
          {isPremiumPlus ? (
            ...
            <Link href="/auth/signup" className="inline-flex items-center gap-2 rounded-xl bg-ikz-lime shadow-glow-lime hover:shadow-glow-lime-lg px-10 py-4 text-base font-bold text-ikz-bg hover:opacity-90 transition-all">
              {t.buyNow} <ChevronRight size={16} />
            </Link>
          )}
        </div>
